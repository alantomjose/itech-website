...
export default function ContactUs() {
  return (
    <div className="contact-container w-full max-w-5xl mx-auto rounded-md overflow-hidden shadow-2xl flex flex-col-reverse md:flex-row bg-white border border-gray-200 md:p-0 p-2">
      {/* Left: Contact Info */}
